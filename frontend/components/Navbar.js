      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-t border-[rgba(15,23,42,0.06)] pb-safe shadow-[0_-10px_40px_-10px_rgba(0,0,0,0.05)]">
        <div className="flex items-center justify-around px-2 py-3">
          ...
          {user ? (
            ...
            <Link href={`/auth/login?redirect=${encodeURIComponent(router.asPath)}`} className="flex flex-col items-center gap-1 text-slate-500 hover:text-brand-600 transition-colors">
              <FiUser size={20} />
